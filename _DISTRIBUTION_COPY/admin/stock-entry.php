    ...
    <script>
        ...
        function openQuickModal(type) {
            ...
            if (type === 'sup') {
                ...
                fields.innerHTML = `<label>Nome/Razão Social</label><input type="text" id="q-name" required>
                                   <label>CNPJ</label><input type="text" id="q-cnpj">`;
            } else {
                title.innerText = 'Novo Produto Rápido';
                fields.innerHTML = `<label>Nome do Produto</label><input type="text" id="q-name" required>
