...
CREATE TABLE `settings` (
  ...
  `site_name` varchar(100) NOT NULL DEFAULT 'Fight Arcade',
  `whatsapp_phone` varchar(30) NOT NULL DEFAULT '5511988121976',
  `admin_email` varchar(100) NOT NULL DEFAULT 'deletrics@gmail.com',
  `logo_path` varchar(255) DEFAULT NULL,
  `banner_title` varchar(120) DEFAULT 'Catálogo Fight Arcade',
  `banner_subtitle` varchar(255) DEFAULT 'Fliperamas, peças e controles para atacado',
...
('Fight Arcade', '5511988121976', 'deletrics@gmail.com');
