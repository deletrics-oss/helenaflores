    ...
    <div class="container" style="padding-top:2rem;">
        ...
        <form method="POST">
            ...
            <div class="module-card">
             ...
             <!-- AI SDR -->
            <h2 style="color:#0084FF; margin-top:3rem;">🤖 Inteligência Artificial (SDR)</h2>
            <div class="module-card" style="border: 1px solid #0084FF;">
                <div class="module-header">
                    <div style="display:flex; align-items:center; gap:10px;">
                        <img src="https://www.gstatic.com/lamda/images/gemini_sparkle_v002_d473530c25e29dc1131c.svg" style="width:24px;">
                        <h3>Gemini SDR - Atendimento Especialista</h3>
                    </div>
                    <label class="switch">
                        <input type="checkbox" name="modules[ai_sdr][active]" value="1" <?php echo isChk($modMap, 'ai_sdr'); ?>>
                        <span class="slider" style="background-color:#0084FF;"></span>
                    </label>
                </div>
                <div class="module-body">
                    <p style="color:#aaa; font-size:0.9rem; margin-bottom:1rem;">
                        O SDR utiliza a IA do <b>Google (Gemini 2.0 Flash)</b> para um atendimento rápido, 
                        humanizado e com memória de curto prazo (lembra o contexto da conversa).
                    </p>
                    
                    <div class="form-group">
                        <label>Gemini API Key:</label>
                        <input type="password" name="modules[ai_sdr][keys][gemini_key]"
                            placeholder="Cole sua chave da Google AI Studio"
                            value="<?php echo htmlspecialchars(getVal($modMap, 'ai_sdr', 'gemini_key')); ?>">
                    </div>

                    <div class="form-group">
                        <label>📝 Lógica de Atendimento Personalizada (Prompt):</label>
                        <textarea name="modules[ai_sdr][keys][custom_logic]" rows="6" 
                            placeholder="Ex: 'Sempre ofereça 5% de desconto para pagamento via PIX.' ou 'Nunca fale mal da concorrência.'"
                            style="width: 100%; padding: 0.8rem; background: #111; border: 1px solid #444; color: #fff; border-radius: 4px; font-family: 'Segoe UI', sans-serif;"><?php echo htmlspecialchars(getVal($modMap, 'ai_sdr', 'custom_logic')); ?></textarea>
                        <small style="color:#666;">Dica: Seja específico sobre promoções, frete e tom de voz.</small>
                    </div>

                    <div style="background:rgba(0,132,255,0.1); padding:10px; border-radius:6px; border-left:4px solid #0084FF;">
                        <small style="color:#fff;">
                            💡 <b>Memória Ativada:</b> O SDR agora consulta as últimas 8 mensagens para manter o contexto do atendimento.
                        </small>
                    </div>
                </div>
            </div>
