...
<body>
    ...
    <div class="container" style="padding-top:2rem;">
        ...
        <div
            ...
            <div class="mk-card">
                <span class="mk-icon">🎵</span>
                <h3 class="mk-title">TikTok Shop</h3>
                <p class="mk-desc">Exporte produtos para o Catálogo do TikTok (Product Feed).</p>
                <form method="POST" action="export_tiktok.php" id="formTikTok">
                    <input type="hidden" name="selected_ids" id="tiktokIds" value="">
                    <?php if (count(glob('../modeloplanilhasshopeemercadolivre/TikTok*.xlsx')) > 0): ?>
                        <div
                            style="background:#00f2ea; color:#000; padding:5px; font-size:0.8rem; margin-bottom:5px; border-radius:4px;">
                            Template Ativo Detectado
                        </div>
                    <?php endif; ?>
                    <button type="submit" class="btn btn-mk" style="background: #000; color:#fff;">⬇️ Baixar
                        CSV/XLSX</button>
                    <a href="tiktok_template_manager.php" class="btn btn-mk"
                        style="background: #333; color:#fff; margin-top:5px; display:block; text-decoration:none; font-size:0.85em;">🛠️
                        Gerenciar Template</a>
                </form>
                <small style="display:block; margin-top:10px; color:#666;">Use o modelo oficial do TikTok</small>
            </div>
            ...
            <div class="mk-card">
                ...
                <a href="products.php?filter=incomplete" class="btn btn-mk" style="background: #333;">🔍 Ver Produtos
                    Incompletos</a>
            </div>
            ...
            <div class="mk-card">
                ...
                <a href="marketplace_categories.php" class="btn btn-mk" style="background: #9b59b6;">⚙️ Gerenciar
                    Categorias</a>
            ...
            <script>
                ...
                window.addEventListener('DOMContentLoaded', function () {
                    ...
                    if (selected) {
                        ...
                        document.getElementById('tiktokIds').value = JSON.stringify(ids);
                    }
                });
            </script>
</body>
