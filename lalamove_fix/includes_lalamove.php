...
class LalamoveAPI {
    ...
    // Veículos disponíveis no Brasil com labels amigáveis
    const SERVICE_TYPES = [
    ...
    public function getQuotation($toCoords, $toAddress, $serviceType = 'MOTORCYCLE', $specialRequests = []) {
        $path = '/v3/quotations';
        $data = [
            ...
            'stops'       => [
                [
                    'coordinates' => [
                        'lat' => (string)$this->storeLatLng['lat'],
                        'lng' => (string)$this->storeLatLng['lng'],
                    ],
    ...
    public function getAllQuotations($toCoords, $toAddress, $specialRequests = []) {
        $results = [];
        foreach (array_keys(self::SERVICE_TYPES) as $serviceType) {
            $res = $this->getQuotation($toCoords, $toAddress, $serviceType, $specialRequests);
    ...
    // ==================== Criar Pedido ====================
    public function createOrder($quotationId, $stops, $recipientName, $recipientPhone, $remarks = '', $notifySms = true, $paymentMethod = 'WALLET', $totalValue = 0) {
        $path = '/v3/orders';
        ...
        $body = [
            'data' => [
                ...
                'sender'      => [
                    ...
                    'name'   => $this->storeName,
                    'phone'  => $this->formatPhone($this->storePhone),
                ],
